...
Mat<eT>::init_cold()
  {
  arma_extra_debug_sigprint( arma_format::format("n_rows = %d, n_cols = %d") % n_rows % n_cols );
...
Mat<eT>::init_warm(uword in_n_rows, uword in_n_cols)
  {
  arma_extra_debug_sigprint( arma_format::format("in_n_rows = %d, in_n_cols = %d") % in_n_rows % in_n_cols );
...
Mat<eT>::Mat(const Mat<eT>& in_mat)
  ...
  , mem()
  {
  arma_extra_debug_sigprint(arma_format::format("this = %x   in_mat = %x") % this % &in_mat);
