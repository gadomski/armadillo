...
Cube<eT>::Cube(const SizeCube& s, const fill::fill_class<fill_type>&)
  ...
  Cube<eT>::Cube(Cube<eT>&& in_cube)
    ...
    {
    arma_extra_debug_sigprint_this(this);
    arma_extra_debug_sigprint(arma_format::format("this = %x   in_cube = %x") % this % &in_cube);
...
Cube<eT>::init_cold()
  {
  arma_extra_debug_sigprint( arma_format::format("n_rows = %d, n_cols = %d, n_slices = %d") % n_rows % n_cols % n_slices );
...
Cube<eT>::init_warm(const uword in_n_rows, const uword in_n_cols, const uword in_n_slices)
  {
  arma_extra_debug_sigprint( arma_format::format("in_n_rows = %d, in_n_cols = %d, in_n_slices = %d") % in_n_rows % in_n_cols % in_n_slices );
...
Cube<eT>::Cube(const Cube<eT>& x)
  ...
  {
  arma_extra_debug_sigprint_this(this);
  arma_extra_debug_sigprint(arma_format::format("this = %x   in_cube = %x") % this % &x);
...
Cube<eT>::swap(Cube<eT>& B)
  ...
  arma_extra_debug_sigprint(arma_format::format("A = %x   B = %x") % &A % &B);
