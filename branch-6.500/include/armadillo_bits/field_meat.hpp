...
field<oT>::field(const field& x)
  ...
  , mem(0)
  {
  arma_extra_debug_sigprint(arma_format::format("this = %x   x = %x") % this % &x);
...
field<oT>::set_size(const uword n_elem_in)
  {
  arma_extra_debug_sigprint(arma_format::format("n_elem_in = %d") % n_elem_in);
...
field<oT>::set_size(const uword n_rows_in, const uword n_cols_in)
  {
  arma_extra_debug_sigprint(arma_format::format("n_rows_in = %d, n_cols_in = %d") % n_rows_in % n_cols_in);
...
field<oT>::set_size(const uword n_rows_in, const uword n_cols_in, const uword n_slices_in)
  {
  arma_extra_debug_sigprint(arma_format::format("n_rows_in = %d, n_cols_in = %d, n_slices_in = %d") % n_rows_in % n_cols_in % n_slices_in);
...
field<oT>::delete_objects()
  {
  arma_extra_debug_sigprint( arma_format::format("n_elem = %d") % n_elem );
