...
//   inline
//   void
//   gelsy(blas_int* m, blas_int* n, blas_int* nrhs, eT* a, blas_int* lda, eT* b, blas_int* ldb, blas_int* jpvt, eT* rcond, blas_int* rank, eT* work, blas_int* lwork, blas_int* info)
//     {
//     arma_type_check(( is_supported_blas_type<eT>::value == false ));
//     
//     if(is_float<eT>::value)
//       {
//       typedef float T;
//       arma_fortran(arma_sgelsy)(m, n, nrhs, (T*)a, lda, (T*)b, ldb, jpvt, (T*)rcond, rank, (T*)work, lwork, info);
//       }
//     else
//     if(is_double<eT>::value)
//       {
//       typedef double T;
//       arma_fortran(arma_dgelsy)(m, n, nrhs, (T*)a, lda, (T*)b, ldb, jpvt, (T*)rcond, rank, (T*)work, lwork, info);
//       }
//     }
//   
//   
...
//   inline
//   void
//   cx_gelsy(blas_int* m, blas_int* n, blas_int* nrhs, void* a, blas_int* lda, void* b, blas_int* ldb, blas_int* jpvt, T* rcond, blas_int* rank, void* work, blas_int* lwork, eT* rwork, blas_int* info)
//     {
//     arma_type_check(( is_supported_blas_type<eT>::value == false ));
//     
//     if(is_supported_complex_float<eT>::value)
...
//       typedef float               pod_T;
//       typedef std::complex<float>  cx_T;
//       arma_fortran(arma_cgelsy)(m, n, nrhs, (cx_T*)a, lda, (cx_T*)b, ldb, jpvt, (pod_T*)rcond, rank, (cx_T*)work, lwork, (pod_T*)rwork, info);
//       }
//     else
//     if(is_supported_complex_double<eT>::value)
//       {
//       typedef double               pod_T;
//       typedef std::complex<double>  cx_T;
//       arma_fortran(arma_zgelsy)(m, n, nrhs, (cx_T*)a, lda, (cx_T*)b, ldb, jpvt, (pod_T*)rcond, rank, (cx_T*)work, lwork, (pod_T*)rwork, info);
//       }
//     }
  ...
  sysvx(char* fact, char* uplo, blas_int* n, blas_int* nrhs, const eT* a, blas_int* lda, eT* af, blas_int* ldaf, blas_int* ipiv, const eT* b, blas_int* ldb, eT* x, blas_int* ldx, eT* rcond, eT* ferr, eT* berr, eT* work, blas_int* lwork, blas_int* iwork, blas_int* info)
    ...
    if(is_float<eT>::value)
      {
      typedef float T;
      arma_fortran(arma_ssysvx)(fact, uplo, n, nrhs, (T*)a, lda, (T*)af, ldaf, ipiv, (T*)b, ldb, (T*)x, ldx, (T*)rcond, (T*)ferr, (T*)berr, (T*)work, lwork, iwork, info);
      }
    else
    if(is_double<eT>::value)
      {
      typedef double T;
      arma_fortran(arma_dsysvx)(fact, uplo, n, nrhs, (T*)a, lda, (T*)af, ldaf, ipiv, (T*)b, ldb, (T*)x, ldx, (T*)rcond, (T*)ferr, (T*)berr, (T*)work, lwork, iwork, info);
      }
    }
  ...
  cx_sysvx(char* fact, char* uplo, blas_int* n, blas_int* nrhs, const eT* a, blas_int* lda, eT* af, blas_int* ldaf, blas_int* ipiv, const eT* b, blas_int* ldb, eT* x, blas_int* ldx, T* rcond, T* ferr, T* berr, eT* work, blas_int* lwork, T* rwork, blas_int* info)
    ...
    if(is_supported_complex_float<eT>::value)
      ...
      typedef float               pod_T;
      typedef std::complex<float>  cx_T;
      arma_fortran(arma_csysvx)(fact, uplo, n, nrhs, (cx_T*)a, lda, (cx_T*)af, ldaf, ipiv, (cx_T*)b, ldb, (cx_T*)x, ldx, (pod_T*)rcond, (pod_T*)ferr, (pod_T*)berr, (cx_T*)work, lwork, (pod_T*)rwork, info);
      }
    else
    if(is_supported_complex_double<eT>::value)
      {
      typedef double               pod_T;
      typedef std::complex<double>  cx_T;
      arma_fortran(arma_zsysvx)(fact, uplo, n, nrhs, (cx_T*)a, lda, (cx_T*)af, ldaf, ipiv, (cx_T*)b, ldb, (cx_T*)x, ldx, (pod_T*)rcond, (pod_T*)ferr, (pod_T*)berr, (cx_T*)work, lwork, (pod_T*)rwork, info);
      }
    }
