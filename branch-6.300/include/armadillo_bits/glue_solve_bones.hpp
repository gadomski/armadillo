...
class glue_solve
  ...
  template<typename eT, typename T1, typename T2> inline static bool solve_robust(Mat<eT>& out, const Base<eT,T1>& A_expr, const Base<eT,T2>& B_expr, const bool slow);
