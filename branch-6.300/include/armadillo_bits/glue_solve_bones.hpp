...
namespace solve_opts
  ...
  static const uword flag_fullrankonly = uword(1u << 0);
  ...
  struct opts_fullrankonly : public opts { inline opts_fullrankonly() : opts(flag_fullrankonly) {} };
  ...
  static const opts_fullrankonly fullrankonly;
