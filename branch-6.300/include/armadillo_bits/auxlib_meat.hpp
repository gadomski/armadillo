...
inline
bool
auxlib::solve_sym(Mat<typename T1::elem_type>& out, Mat<typename T1::elem_type>& A, const Base<typename T1::elem_type,T1>& B_expr, const uword layout)
  {
  arma_extra_debug_sigprint();
...
inline
bool
auxlib::solve_sym_ext(Mat<typename T1::pod_type>& out, const Mat<typename T1::pod_type>& A, const Base<typename T1::pod_type,T1>& B_expr, const uword layout)
  {
  arma_extra_debug_sigprint();
    ...
    arma_extra_debug_print("lapack::sysvx()");
    lapack::sysvx
      (
      &fact, &uplo, 
      &n, &nrhs,
...
inline
bool
auxlib::solve_sym_ext(Mat< std::complex<typename T1::pod_type> >& out, const Mat< std::complex<typename T1::pod_type> >& A, const Base<std::complex<typename T1::pod_type>,T1>& B_expr, const uword layout)
  {
  arma_extra_debug_sigprint();
    ...
    arma_extra_debug_print("lapack::cx_sysvx()");
    lapack::cx_sysvx
      (
      &fact, &uplo,
      &n, &nrhs,
